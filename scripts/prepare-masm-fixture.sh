...
RECORDER_TARGET_DIR="$(recorder_target_dir "$MIDEN_RECORDER_DIR")"
recorder_exec "$MIDEN_RECORDER_DIR" env CARGO_TARGET_DIR="$RECORDER_TARGET_DIR" \
  cargo build --manifest-path "$MIDEN_RECORDER_DIR/Cargo.toml"

# Locate the built binary
RECORDER_BIN="$RECORDER_TARGET_DIR/debug/codetracer-miden-recorder"
