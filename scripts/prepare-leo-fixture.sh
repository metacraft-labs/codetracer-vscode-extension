...
RECORDER_TARGET_DIR="$(recorder_target_dir "$LEO_RECORDER_DIR")"
recorder_exec "$LEO_RECORDER_DIR" env CARGO_TARGET_DIR="$RECORDER_TARGET_DIR" \
  cargo build --manifest-path "$LEO_RECORDER_DIR/Cargo.toml"

# Locate the built binary
RECORDER_BIN="$RECORDER_TARGET_DIR/debug/codetracer-leo-recorder"
